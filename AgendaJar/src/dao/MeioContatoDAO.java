...
public class MeioContatoDAO {
    ...
    public MeioContato gravar(MeioContato contato) throws DataAccessException {
        return em.merge(contato);
    }

    public void excluir(MeioContato contato) throws DataAccessException {
        em.remove(carregar(contato.getIdMeioContato()));
    }
